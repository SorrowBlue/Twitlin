//[twitlin](../../../index.md)/[com.sorrowblue.twitlin.media](../../index.md)/[MediaCategory](../index.md)/[DM_IMAGE](index.md)



# DM_IMAGE  
 [common] [DM_IMAGE](index.md)()  
...
|  Name|  Summary| 
|---|---|
| <a name="com.sorrowblue.twitlin.media/MediaCategory.DM_IMAGE/name/#/PointingToDeclaration/"></a>[name](name.md)| <a name="com.sorrowblue.twitlin.media/MediaCategory.DM_IMAGE/name/#/PointingToDeclaration/"></a> [common] val [name](name.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
