...
public object Twitlin {
    ...
    internal fun initialize(
        ...
        userClient = UserClient(apiKey, apiSecret, accessToken)
        appClient = AppClient(apiKey, apiSecret, bearerToken)
...
internal const val DEFAULT_TAG = "Twitlin"
