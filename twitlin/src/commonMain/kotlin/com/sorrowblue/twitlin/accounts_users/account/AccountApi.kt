...
interface AccountApi {
	 ...
	 * The WOEID must be one of the locations returned by [TrendsApi.available].
	 ...
	 * Currently supported languages are provided by [HelpApi.languages].
	 ...
	 * More information about sizing variations can be found in User Profile Images and Banners and [UsersApi.profileBanner].
	 ...
	 * or at least 5 seconds after uploading the image, ask for the updated URL using [UsersApi.show].
	 *
