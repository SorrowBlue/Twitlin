...
import com.sorrowblue.twitlin.api.users.friendships.Friendships
...
import com.sorrowblue.twitlin.core.util.API_FRIENDSHIPS
...
internal class FriendshipsApiImpl(private val client: TwitterClient) : FriendshipsApi {
    ...
    private suspend fun lookupImpl(userId: List<UserId>?, screenName: List<String>?): Response<List<Friendships>> {
        return client.get(
            "$API_FRIENDSHIPS/lookup.json",
            Response.serializer(ListSerializer(Friendships.serializer()))
        ) {
