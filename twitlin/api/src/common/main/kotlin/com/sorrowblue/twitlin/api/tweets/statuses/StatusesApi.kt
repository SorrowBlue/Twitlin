...
public interface StatusesApi {
     ...
     * @return
     */
    @Deprecated("The endpoints replaces com.sorrowblue.twitlin.api.v2.tweets.TweetsApi#retweetedBy.")
     ...
     * @return
     */
    @Deprecated("The endpoints replaces com.sorrowblue.twitlin.api.v2.users.UsersApi#retweet.")
     ...
     * @return
     */
    @Deprecated("The endpoints replaces com.sorrowblue.twitlin.api.v2.users.UsersApi#deleteRetweet.")
