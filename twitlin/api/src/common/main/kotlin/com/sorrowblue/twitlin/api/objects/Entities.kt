...
import com.sorrowblue.twitlin.api.objects.Entities.Media.MediaSize.Size.Resize
import com.sorrowblue.twitlin.api.objects.Entities.URL.Unwound
...
public data class Entities(
    ...
    public data class Poll(
        ...
        internal val _endDatetime: String,
        ...
        val endDatetime: LocalDateTime
            get() = _endDatetime.rfc822ToLocalDateTime()
        ...
        @AndroidParcelize
        @Serializable
        public data class Option(val position: Int = -1, val text: String = "") :
            AndroidParcelable, JvmSerializable
    }
}
