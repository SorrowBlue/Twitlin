...
public sealed class Problem : AndroidParcelable {
...
public class InvalidRequestProblem(
    ...
    @AndroidParcelize
    @Serializable
    public class Error(public val parameters: Map<String, List<String>>, public val message: String) : AndroidParcelable
}
