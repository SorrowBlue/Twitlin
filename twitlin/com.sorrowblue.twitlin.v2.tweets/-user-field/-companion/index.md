//[twitlin](../../../index.md)/[com.sorrowblue.twitlin.v2.tweets](../../index.md)/[UserField](../index.md)/[Companion](index.md)
...
|  Name|  Summary| 
|---|---|
| <a name="com.sorrowblue.twitlin.v2.tweets/UserField.Companion/all/#/PointingToDeclaration/"></a>[all](all.md)| <a name="com.sorrowblue.twitlin.v2.tweets/UserField.Companion/all/#/PointingToDeclaration/"></a>[common]  <br>Content  <br>fun [all](all.md)(): [List](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-list/index.html)<[UserField](../index.md)>  <br><br><br>
