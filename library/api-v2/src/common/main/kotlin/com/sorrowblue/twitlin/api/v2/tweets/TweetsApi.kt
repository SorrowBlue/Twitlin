...
import com.sorrowblue.twitlin.api.v2.tweets.impl.TweetOption
...
import com.sorrowblue.twitlin.api.v2.users.Expansion as UserExpansion

/**
 * TODO
 */
public interface TweetsApi  : TwitterAPIv2 {
     ...
     * @param backfillMinutes By passing this parameter, you can request up to five (5) minutes worth of streaming data that you might have missed during a disconnection to be delivered to you upon reconnection.
     * The backfilled Tweets will automatically flow through the reconnected stream, with older Tweets generally being delivered before any newly matching Tweets. You must include a whole number between 1 and 5 as the value to this parameter.
     * This feature will deliver duplicate Tweets, meaning that if you were disconnected for 90 seconds, and you requested two minutes of backfill, you will receive 30 seconds worth of duplicate Tweets.
     * Due to this, you should make sure your system is tolerant of duplicate data.
     * This feature is currently only available to those that have been approved for Academic Research access.
     * To learn more about this access level, please visit our section on [Academic Research](https://developer.twitter.com/en/products/twitter-api/academic-research).
