...
import com.sorrowblue.twitlin.api.API_COLLECTIONS
...
import com.sorrowblue.twitlin.api.tweets.collections.CollectionDestroy
import com.sorrowblue.twitlin.api.tweets.collections.CollectionObjects
import com.sorrowblue.twitlin.api.tweets.collections.CollectionResponse
import com.sorrowblue.twitlin.api.tweets.collections.Collections
import com.sorrowblue.twitlin.api.tweets.collections.CollectionsApi
import com.sorrowblue.twitlin.api.tweets.collections.TimelineOrder
...
internal class CollectionsApiImpl(private val client: TwitterClient) : CollectionsApi {
    ...
    override suspend fun curateEntries(
        ...
        return client.post("$API_COLLECTIONS/entries/curate.json", Response.serializer(unitErrorsSerializer)) {
            ...
            setBody(CreateEntriesRequest(id, changes))
        }
    }
