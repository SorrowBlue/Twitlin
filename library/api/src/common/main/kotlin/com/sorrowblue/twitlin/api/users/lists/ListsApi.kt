 ...
 */
public interface ListsApi : TwitterAPI {

    /**
     * Returns all lists the authenticating or specified user subscribes to, including their own.
     * The user is specified using the [userId] or parameters. If no user is given,
     ...
     * @return
     */
    public suspend fun list(userId: UserId, reverse: Boolean = false): Response<List<UserList>>

    /**
     * Returns all lists the authenticating or specified user subscribes to, including their own.
     * The user is specified using the or [screenName] parameters. If no user is given,
     * the authenticating user is used.
     *
     * A maximum of `100` results will be returned by this call. Subscribed lists are returned
     * first, followed by owned lists. This means that if a user subscribes to `90` lists and owns
     ...
     * @return
     */
    public suspend fun list(screenName: String, reverse: Boolean = false): Response<List<UserList>>
     ...
     * do so, note that you'll also have to specify the list owner using the or [ownerScreenName] parameters.
     ...
     *
     * @param slug You can identify a list by its slug instead of its numerical id. If you decide to
     * do so, note that you'll also have to specify the list owner using the [ownerId] or parameters.
     ...
     * to do so, note that you'll also have to specify the list owner using the [ownerId] parameters.
     ...
     *
     * @param slug You can identify a list by its slug instead of its numerical id. If you decide
     * to do so, note that you'll also have to specify the list owner using the [ownerScreenName] parameters.
     * @param ownerScreenName The screen name of the user who owns the list being requested by
     * a slug.
     * @param userId The ID of the user for whom to return results. Helpful for disambiguating when
     * a valid user ID is also a valid screen name.
     ...
     * @return
     */
    public suspend fun destroy(listId: ListId): Response<UserList>
     ...
     * @return
     */
    public suspend fun createSubscribers(listId: ListId): Response<UserList>
     ...
     * @return
     */
    public suspend fun destroySubscribers(listId: ListId): Response<UserList>
